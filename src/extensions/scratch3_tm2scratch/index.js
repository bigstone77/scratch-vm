...
const Message = {
    ...
    set_confidence_threshold: {
        'ko': '기준 값을 [CONFIDENCE_THRESHOLD](으)로 설정',
    ...
    set_classification_interval: {
    		'ko': '분류 간격을 [CLASSIFICATION_INTERVAL]초로 설정',
